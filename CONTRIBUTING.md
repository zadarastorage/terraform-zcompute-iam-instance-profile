# Contributing to terraform-zcompute-iam-instance-profile

Thank you for your interest in contributing to the terraform-zcompute-iam-instance-profile module! This document provides guidelines and instructions for contributing to the project.
...
```bash
git clone https://github.com/zadarastorage/terraform-zcompute-iam-instance-profile.git
cd terraform-zcompute-iam-instance-profile
...
**Note:** IAM tests create IAM roles and instance profiles in zCompute.
...
```
feat!: remove deprecated profile_name variable

BREAKING CHANGE: The profile_name variable has been removed. Use name instead.
```
...
git commit -m "feat: add support for custom IAM policies"

# Bug fix - triggers patch version bump
git commit -m "fix: correct role trust policy"

# Documentation - no version bump
git commit -m "docs: add examples for cross-account access"
...
Thank you for contributing to terraform-zcompute-iam-instance-profile!
