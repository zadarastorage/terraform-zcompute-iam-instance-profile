# zCompute Provider Configuration for Integration Tests
#
# Note: IAM resources may not support tags in zCompute (see RESEARCH.md).
# Tag applied best-effort via default_tags.
